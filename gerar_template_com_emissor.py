...
def create_araujo_receipt_template():
    """Cria um template de recibo oficial da Araujo Prev com campo de emissor"""
    doc = Document()
    ...
    # ── RODAPÉ COM EMISSOR ──
    p_rodape = add_paragraph(doc, "Emitido por: {{ emitido_por }}", size=9, align=WD_ALIGN_PARAGRAPH.RIGHT)
    
    # Salvar template
    template_path = "template/recibo_template.docx"
    doc.save(template_path)
    print(f"✅ Template com campo de emissor criado com sucesso em: {template_path}")
